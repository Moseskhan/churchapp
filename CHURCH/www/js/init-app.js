...
setAmplifyValue("networkstatus", navigator.connection.type);
    ...
    el = document.getElementById("id_boot-sound") ;
    el.addEventListener(evt, app.playNativeAudioButton, false) ;
    el = document.getElementById("id_sound-bowl") ;
    el.addEventListener(evt, app.playNativeAudioButton, false) ;
    el = document.getElementById("id_boot-bowl") ;
    el.addEventListener(evt, app.playConcurrentButton, false) ;

    el = document.getElementById("id_cordova-media-local-start") ;
    el.addEventListener(evt, app.playCordovaAudioButton, false) ;
    el = document.getElementById("id_cordova-media-local-pause") ;
    el.addEventListener(evt, app.pauseCordovaAudio, false) ;
    el = document.getElementById("id_cordova-media-url-start") ;
    el.addEventListener(evt, app.playCordovaAudioButton, false) ;
    el = document.getElementById("id_cordova-media-url-stop") ;
    el.addEventListener(evt, app.stopCordovaAudio, false) ;

    el = document.getElementById("id_html5-audio-local") ;
    el.addEventListener(evt, app.playHtml5AudioButton, false) ;
    el = document.getElementById("id_html5-audio-local-pause") ;
    el.addEventListener(evt, app.pauseHtml5AudioButton, false) ;
    el = document.getElementById("id_html5-audio-local-restart") ;
    el.addEventListener(evt, app.restartHtml5AudioButton, false) ;
    el = document.getElementById("id_html5-audio-url") ;
    el.addEventListener(evt, app.playHtml5AudioButton, false) ;
    el = document.getElementById("id_html5-audio-url-pause") ;
    el.addEventListener(evt, app.pauseHtml5AudioButton, false) ;
    el = document.getElementById("id_html5-audio-url-restart") ;
    el.addEventListener(evt, app.restartHtml5AudioButton, false) ;
